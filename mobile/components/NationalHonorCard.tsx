...
const TIER_DEFS = [
  { key: "bronze" as const, label: "Bronze", color: "#d97706", radius: 24 },
  { key: "silver" as const, label: "Silver", color: "#64748b", radius: 34 },
  { key: "gold" as const, label: "Gold", color: "#ca8a04", radius: 44 },
];
...
export default function NationalHonorCard({
  ...
  return (
    <View
      className="mx-5 mt-5 bg-white rounded-2xl border border-gray-200"
      style={{
        shadowColor: "#000",
        shadowOpacity: 0.06,
        shadowRadius: 10,
    ...
    >
      ...
      <View className="flex-row items-start justify-between px-5 pt-5 pb-3">
        <View className="flex-1 mr-3">
          ...
          <Text className="font-inter text-sm text-slate-500 mt-0.5">
      ...
      <View className="flex-row items-center px-5 pb-5">
        ...
        <View style={{ width: SVG_SIZE, height: SVG_SIZE }}>
          ...
          >
            <Text
              className="font-inter-semibold text-slate-900"
              style={{ fontSize: 26, lineHeight: 30 }}
            >
              {hoursLogged}
            </Text>
            <Text className="font-inter text-xs text-slate-400">hrs</Text>
          </View>
        </View>
